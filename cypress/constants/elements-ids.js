...
export const CAR_SUGGESTION_MAX = 'suggestion-20000'
export const BACK_BUTTON = 'back-button'
export const TOTAL_FOOTPRINT_NUMBER = 'total-footprint-number'
export const SAVE_MODAL_EMAIL_INPUT = 'save-modal-email-input'
