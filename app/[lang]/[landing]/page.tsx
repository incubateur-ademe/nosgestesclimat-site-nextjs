...
export default async function Landing({ lang }: { lang: string }) {
	...
	const { t } = await useServerTranslation(lang, 'landing')

	return (
		<Main>
			<div className="flex items-center justify-center flex-wrap mt-12 p-2 gap-4 w-full max-w-[36rem] mx-auto">
			...
			<div className="flex justify-between items-center flex-wrap max-w-[70%] mx-auto mt-4">
				<Image
					src={republiqueFr}
