...
export default function CountryListItem({
  ...
  return (
    <Card
      ...
      className={`bg-white text-default flex h-16 w-24 items-center justify-center gap-2 px-3 py-2 text-center text-xs shadow-none sm:h-12 sm:!w-36 sm:flex-row sm:justify-start sm:py-0 sm:text-left ${
