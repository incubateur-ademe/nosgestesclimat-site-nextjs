...
export default async function Route404() {
  ...
  return (
    <div className="relative h-svh">
      <div className="absolute bottom-0 left-0 right-0 top-0 bg-[#1617C5] opacity-75" />
      <div className="relative mt-20 flex flex-col items-center lg:mt-36">
        <div className="relative w-full bg-white">
          <h1 className="mb-2 flex items-center justify-center text-[10rem] font-black text-amber-400  md:text-[20rem]">
            <span className="island leading-none">4</span>
            <span className="island relative leading-none">
              <Image
                className="absolute -top-16 left-0 right-0 m-auto w-10 md:w-12"
          ...
          <Wave
            fill="#1617C5"
            className="absolute bottom-0 left-0 right-0 h-full w-full opacity-75"
            options={{
              height: 70,
              amplitude: 70,
              speed: 0.11,
