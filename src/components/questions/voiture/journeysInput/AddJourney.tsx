...
export default function JourneyItem({ setJourneys }: Props) {
  ...
  return (
    <tr className="block">
      <td className="block border-t border-primary-500 py-4 pl-2 pr-2 text-sm md:table md:pr-4">
        <Select
      ...
      <td className="block border-t border-primary-500 px-2 py-4 text-sm md:table md:px-4">
      ...
      <td className="block border-t border-primary-500 py-4 pl-2 pr-2 text-right text-sm md:table md:pl-4">
        <Button
          size="sm"
          onClick={() =>
