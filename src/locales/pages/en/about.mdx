<div className="flex flex-wrap gap-16 pb-8 md:flex-nowrap">
  <div>
    ...
    This calculator allows you to assess your individual carbon footprint
    and by major category (food, transport, housing
    (food, transport, housing, miscellaneous, social services),
    see how it compares with your climate targets and, above all
    take action at your own level with personalised measures
...
The calculator is constantly being improved.
...
We collect anonymised data only to improve this calculator
calculator.
...
## How to integrate this calculator into your site?
