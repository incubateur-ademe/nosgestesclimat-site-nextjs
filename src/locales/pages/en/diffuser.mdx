...
Join <a href="/ambassadeurs">the many current reusers</a>.
...
Go to <a href="sondages.nosgestesclimat.fr">🏟️ group mode</a> on choose a room name, share the link, and launch the simulation game!
