...
The site is hosted on Vercel. It is a static site served via a CDN.
...
The site is protected by an electronic certificate, represented by a padlock for the vast majority of
browsers by a padlock. This protection contributes to the confidentiality of exchanges.
Under no circumstances will the services associated with the platform be used to send emails
