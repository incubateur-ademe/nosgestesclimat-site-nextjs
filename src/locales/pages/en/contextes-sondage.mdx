...
Thus, an organisation can send a single survey link and receive
...
in the
[/contexts-survey](https://github.com/incubateur-ademe/nosgestesclimat-server/tree/master/contextes-sondage)
folder.
