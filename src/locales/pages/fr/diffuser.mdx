...
`https://nosgestesclimat.fr/en/partenaires`
...
Rejoignez ainsi [les nombreux réutilisateurs actuels](/ambassadeurs).
...
Rendez-vous [🏟️ mode groupe](sondages.nosgestesclimat.fr) sur choissiez un nom de salle, partagez le lien, et lancez le match de simulation !
...
<div lang="en">
  We are looking for native partners to translate and adapt the GHG emissions
  model for the specificities of other countries.
</div>
