...
![Concentration de carbone dans l’atmosphère, en parties par million (ppm) : données issues des carottes glaciaires avant 1958, des mesures de Mauna Loa depuis.](https://nosgestesclimat-prod.s3.fr-par.scw.cloud/cms/ges_evolution_6a33a1859f.png)
...
![Les neuf limites planétaires, [image de notre-environnement.gouv.fr](https://www.notre-environnement.gouv.fr/themes/societe/article/limites-planetaires)](https://nosgestesclimat-prod.s3.fr-par.scw.cloud/cms/9_limites_planetaires_b4750fa8e0.png)
...
![[Source](https://www.futura-sciences.com/planete/actualites/climatologie-taux-gaz-effet-serre-atmosphere-battent-tous-records-60411/)](https://nosgestesclimat-prod.s3.fr-par.scw.cloud/cms/ges_monde_c9613a3a3e.png)
...
![Répartition des empreintes calculées sur le site Nos Gestes Climat - étude OpinionWay](https://nosgestesclimat-prod.s3.fr-par.scw.cloud/cms/empreinte_france_9db10a36c5.png)
...
Depuis 2020, l’ADEME (l’Agence de la transition écologique) a mis en ligne un calculateur, entièrement ouvert, libre et documenté, pour calculer son empreinte individuelle : [Nos Gestes Climat](https://nosgestesclimat.fr/). Pédagogique, il vous invite à réaliser votre bilan carbone individuel en quelques minutes. Contributif, il permet aux utilisateurs de questionner, suggérer ou critiquer le calculateur, participant ainsi à sa qualité.
