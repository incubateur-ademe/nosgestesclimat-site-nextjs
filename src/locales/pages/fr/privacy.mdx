...
L’entreprise Vercel héberge Nos Gestes Climat. Vercel est une entreprise américaine dont le siège social est situé à Covina en Californie : https://vercel.com/legal/privacy-policy
...
et disponible [sur github](https://github.com/incubateur-ademe/nosgestesclimat-server).
...
Les données sont conservées localement sur le navigateur jusqu’à l'action de l'utilisateur pour effacer les données du navigateur, du domaine nosgestesclimat.fr en particulier, ou via la [page profil](/profil). Leur durée de conservation est donc dépendante de l'utilisateur.
...
Pour toutes autres questions, veuillez nous contacter via notre [formulaire de contact](/contact) (@équipe-ngc).
