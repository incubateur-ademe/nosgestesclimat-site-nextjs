...
![Tableau : exemples d'éco-gestes pour économiser l'énergie dans son logement](/images/actions/maitrise-conso-elec-logement-tab1.jpg)

`Tableau 1 : Exemples d'éco-gestes pour économiser l'énergie dans son logement`

## Ordre de grandeur GES

![Graphique : impact GES associé à la consommation électrique sur une année d'ampoules classiques et d’ampoules basses consommation de type LED](/images/actions/maitrise-conso-elec-logement-fig1.jpg)
