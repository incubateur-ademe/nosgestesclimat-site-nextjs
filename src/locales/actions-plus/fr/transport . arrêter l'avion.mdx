...
![Infographie : un aller-retour Paris-New York émet 1,8 tonnes de CO2 équivalent](/images/actions/Chiffres-clefs_alternatives_bas_carbones_vacances_week-end_v2.png)
...
![Graphique : impact GES pour différents types de trajets, de modes de transports et en fonction du nombre de passage (pour l’avion et le train)](/images/actions/alternative-bas-carbone-fig1.jpg)
