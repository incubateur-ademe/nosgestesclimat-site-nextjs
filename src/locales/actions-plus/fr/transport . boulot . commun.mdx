...
![Graphique : impact GES d'un km parcouru en fonction de différents modes de transports](/images/actions/transport-commun-fig1.jpg)
...
Vous souhaitez évaluer l’impact GES de vos déplacements, le calculateur Mon Impact Transport est là pour vous aider au calcul : <https://monimpacttransport.fr>
