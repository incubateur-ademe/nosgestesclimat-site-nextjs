...
![La fabrication d'un produit électronique représente 80 % de l'empreinte carbone sur son cyle de vie](/images/actions/Chiffres-cles_Achat-elec-reconditionne.png)
...
![25 gCO2eq/Go pour un réseau mobile contre 9 gCO2eq/Go pour un réseau fixe](/images/actions/Impact_GES_réseaux_data.PNG)
