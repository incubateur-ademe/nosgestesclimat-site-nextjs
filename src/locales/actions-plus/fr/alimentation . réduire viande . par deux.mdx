...
![Infographie : la production d'un kilogramme de viande émet 5 à 10 fois plus de GES que celle d'un kilogramme de céréale](/images/actions/Chiffres-cles_reduire_sa_consommation_viande_v2.png)
...
![Graphique : impact GES d'un kg de viande en sortie de ferme et ingéré](/images/actions/reduction-viande-fig1-1.jpg)
`Figure 1 : Impact GES d'un kg de viande en sortie de ferme et ingéré (source Agribalyse)`

![Graphique : impact GES pour différents types de repas](/images/actions/reduction-viande-fig2.jpg)
