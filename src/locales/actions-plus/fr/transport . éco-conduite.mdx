...
![Infographie : l'éco-conduite permet de réduire sa consommation de carburant 15%](/images/actions/Chiffres-clefs_ecoconduite_carburant_v2.png)
...
![Graphique : impact GES avec et sans éco-conduite pour un trajet de 1000 km](/images/actions/eco-conduite-fig1.jpg)
