...
![70% des déplacements domicile-travail sont réalisés avec des véhicules individuels (en autosolisme)](/images/actions/Chiffres-clefs_covoitDT.png)
...
![Graphique : impact GES d'un déplacement de 40 km aller-retour pour différents types de véhicules et en fonction du nombre de passager](/images/actions/covoiturage-d-t-fig1.jpg)

## Ordre de grandeur GES

![Graphique : impact GES d'un déplacement de 40 km aller-retour pour différents types de véhicules et en fonction du nombre de passager](/images/actions/covoiturage-d-t-fig2.jpg)
