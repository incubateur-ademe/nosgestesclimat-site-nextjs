...
![Graphique : impact GES associé à la production d’un kWh électrique en fonction de différents types d’installation](/images/actions/Impact_GES_production_élec.PNG)
