...
![La fabrication d'un produit électronique représente 80 % de l'empreinte carbone sur son cycle de vie](/images/actions/Chiffres-cles_Achat-elec-reconditionne.png)
...
Pour trouver votre point de collecte, utilisez notre calculateur [Que Faire de Mes Déchets](https://quefairedemesdechets.fr/) !

[![Image : Que faire de mes déchets ?](/images/actions/screen-que-faire-de-mes-déchets.png)](https://quefairedemesdechets.fr/)
