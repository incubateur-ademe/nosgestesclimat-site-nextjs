...
![Infographie : croquis empreinte carbone d'un français](/images/actions/HCC_empreinte_carbone_fr.PNG)
...
![Infographie : 1 appareil sur 2 est rapporté au SAV](/images/actions/Chiffres-clefs_Allonger-duree-vie-produits-elec_v2.png)
...
![Infograophie : économies CO2 équivalent en réparant un objet en panne](/images/actions/Economie_GES_reparation.PNG)
...
![Infographie : éviter le renouvellement précoce des nos biens](/images/actions/Chiffres-cles_Resister-pub.png)
...
![Infographie : 70% des vêtements de nos armoires ne sont jamais portés](/images/actions/Chiffres-clefs_Desencombrer_v1.png)
...
![Infographie : la fabrication d'un produit électronique représente 80% de l'empreinte carbone sur son cycle de vie](/images/actions/Chiffres-cles_Achat-elec-reconditionne.png)
...
Plus généralement, le calculateur "Que Faire de mes Déchets" de l'Accélérateur de la Transition Écologique (ADEME) peut vous être utile ! [https://quefairedemesdechets.fr/](https://quefairedemesdechets.fr/)
