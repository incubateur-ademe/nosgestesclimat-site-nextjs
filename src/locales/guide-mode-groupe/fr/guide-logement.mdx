...
![Infographie : les bâtiments représentent 17% des émissions en France](/images/actions/HCC_emissions_secteur_logement.PNG)
...
![Infographie : baisser le chauffage d'un degré dans son logement permet d'économiser 7% d'énergie](/images/actions/Chiffres-cles_limiter_temperature_logement.png)
...
![Infographie : les écogestes dans son logement](/images/actions/Chiffres-cles_Consommation-elec-logement.png)
...
![Infographie : d'ici 2050 le nombre de climatiseurs pourrait passer de 1.6 à 5.6 milliards](/images/actions/Chiffres-cles_Climatisation-passive.png)
...
![Infographie : remplacer une chaudière au fioul ou au gaz par un équipement performant](/images/actions/Chiffres-cles_Changement-chaudiere.png)
...
![Schéma : pertes de chaleur d'une maison non isolée](/images/actions/Pertes_chaleur.PNG)
...
![Infographie : rénover son logement en BBC permet de réduire sa consommation d'énergie de 70%](/images/actions/Chiffres-cles_renovation_energetique_bati_v2.png)
