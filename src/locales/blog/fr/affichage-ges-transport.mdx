...
Sur cette plateforme l’information est affichée, mais peu mise en avant et pas expliquée. Est-ce beaucoup “1 kg de CO2” pour ce trajet ? Et par rapport aux autres modes de transport ? ![Trainline](https://nosgestesclimat.fr/images/blog/infoges-train1.png)

Même chose ici, l’information est visible (à la fois sur ordinateur et sur mobile) mais peu intelligible.

![SNCF](https://nosgestesclimat.fr/images/blog/infoges-train2.jpg 'SNCF')
...
![Oui.sncf](https://nosgestesclimat.fr/images/blog/infoges-train3.png 'Oui.sncf')
...
![Oui.sncf](https://nosgestesclimat.fr/images/blog/infoges-train4.png 'Oui.sncf')
...
![Google Maps](https://nosgestesclimat.fr/images/blog/infoges-carto3.png 'Google Maps')
...
![Mappy](https://nosgestesclimat.fr/images/blog/infoges-carto1.jpg 'Mappy')
...
![Velib](https://nosgestesclimat.fr/images/blog/infoges-velo_libre_service1.jpg 'Velib')
...
Pour les utilisateurs ou utilisatrices du métro, ce site affiche l’information de l’impact CO2 et donne une comparaison avec le même trajet effectué en voiture. Reste que peu de gens savent si 11 g. ou 786 g. c’est beaucoup ou non. Notre culture sur cet indicateur est vraiment limitée pour appréhender ces informations. Un lien rapide amène sur le [bilan carbone de l’opérateur](https://www.ratp.fr/groupe-ratp/pour-la-planete-et-la-ville/engages-contre-le-changement-climatique) de mobilité. ![Metro](https://nosgestesclimat.fr/images/blog/infoges-metro1.png 'Metro')

---

### Autocar

Sur cet opérateur de bus, il n’y a pas de calculateur au moment de la comparaison des offres. Au moment de passer la commande, seule est présente la possibilité de compenser les émissions liées. ![Flixbus](https://nosgestesclimat.fr/images/blog/infoges-bus1.png 'Flixbus')
...
![Easyjet](https://nosgestesclimat.fr/images/blog/infoges-avion1.jpg 'Easyjet')
...
![Corsair](https://nosgestesclimat.fr/images/blog/infoges-avion2.png 'Corsair')

Ici ce billet électronique ne donne pas de chiffres et renvoie sur le site de l’entreprise. ![AirFrance](https://nosgestesclimat.fr/images/blog/infoges-avion4.png 'AirFrance') Et lors du parcours d’achat l’information présentée de manière différente selon qu’on est sur mobile ou sur un ordinateur. Sur la qualité de l’information fournie, laissons [Valérie Masson-Delmotte commenter](https://twitter.com/valmasdel/status/1287714996810592257) cet affichage pour le moins très limité.

![Air France](https://nosgestesclimat.fr/images/blog/infoges-avion5.jpg 'Air France')
...
![Air France](https://nosgestesclimat.fr/images/blog/infoges-avion6.jpg 'Air France')
