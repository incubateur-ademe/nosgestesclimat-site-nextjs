...
description: "Il nous arrive fréquemment de recevoir des questions sur des écogestes absents du calculateur Nos Gestes Climat. C'est que l'empreinte carbone n'est pas le seul enjeu planétaire d'importance... loin de là ! On en compte neuf à surveiller de près."
...
Ces actions sont donc très importantes ! Mais absentes de notre calculateur d’empreinte climat.
...
De nombreuses initiatives (comme par exemples des fresques) permettent de mieux appréhender ces enjeux… et peut-être, bientôt, de nouveaux calculateurs !