...
description: 'Dans le cadre de leur option-projet, les étudiants de Centrale Nantes se sont attelés à cette tâche et ont repris le calculateur pour en faire une version adaptée à leur campus et ainsi dresser le bilan carbone de l’établissement et des occupants.'
...
> En premier lieu, on a été attirés par la clarté des informations autour du calculateur en lui-même et de la [documentation](https://nosgestesclimat.fr/documentation).
>
...
> - la simplicité, l’ergonomie, les suggestions sont autant de caractéristiques et fonctionnalités qui rendent l’expérience utilisateur agréable. Proposer un calculateur affichant les questions les unes après les autres à l’écran nous paraissait également important pour gagner en clarté.
...
>
> Nous sommes actuellement en phase de finalisation. Nous n’avons pas de chiffres précis sur l’utilisation du calculateur. Il est encore peu connu au sein des usagers de l’école. Aujourd’hui, le calculateur est un support d’animation pour certains cours et évènements à Centrale Nantes. L’objectif est d’accentuer les démarches favorisant le déploiement de l’application. La rentrée en septembre 2021 présente un fort enjeu et pourrait être un vrai tremplin pour le calculateur.

### Quelles sont les futures étapes pour l’option-projet ? Et pour le calculateur ? Quelle(s) amélioration(s) aimeriez-vous apporter à votre déclinaison ?
...
>
> Concernant le calculateur « Campus », nous avons en tête de nombreuses perspectives d’amélioration ! La première est le déploiement d’une version anglaise du calculateur pour intégrer tous les étudiants dans la démarche « Neutralité Carbone » de l’école.
>
...
Dépôt du code source de l’interface du calculateur : [https://github.com/SustainabilityCN/nosgestesclimat-site-ECN](https://github.com/SustainabilityCN/nosgestesclimat-site-ECN)
