...
![Se déplacer en voiture : seul, à plusieurs, ou en covoiturage ?](https://prod-files-secure.s3.us-west-2.amazonaws.com/a33bcf70-8792-422e-bd32-0327fc741a8b/39661666-988c-4dd9-b28e-aa45c3dab253/Untitled.png)
...
Pour plus de données sur l'empreinte carbone des transports, ça se passe ici :

<script name="impact-co2" src="https://impactco2.fr/iframe.js" data-type="transport" data-search="?theme=default&tabs=distance&km=15"></script>
...
<div className="text-center"> 
    <a href="https://nosgestesclimat.fr/" className="transition-colors !text-white bg-primary-500 border-2 border-primary-500 shadow-sm hover:text-white hover:bg-primary-700 inline-flex items-center whitespace-nowrap rounded-md font-bold no-underline transition-colors focus:outline-none focus:ring-2 focus:ring-primary-700 focus:ring-offset-3 aria-disabled:opacity-50 transition-color !p-4 mx-auto">Place au simulateur !</a>
</div>
