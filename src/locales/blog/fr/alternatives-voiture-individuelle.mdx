...
![Se déplacer en voiture : seul, à plusieurs, ou en covoiturage ?](/images/blog/Infographie_covoitureage_autosolisme_site_SDES.png)
...
Pouvons-nous opérer un rapprochement du domicile et des activités ? Réduire les déplacements longs liés aux congés ?
...
<div>
  <script
    ...
    data-type="transport"
    data-search="?theme=default&tabs=distance&km=15"></script>
  <iframe
