...
description: 'Cette invitation à perdre quelques tonnes, un brin provoquante, ne date pas d’hier : c’était déjà celle du Coach Carbone lancé en 2010 par l’ADEME et la FNH (Fondation pour la Nature et l’Homme) créée par Nicolas Hulot.'
image: '/images/blog/coachcarbone.jpg'
categories: 'En coulisses'
...
Alors revenons sur la génèse de notre calculateur, fruit d’un long travail de nombreux acteurs que nous souhaitons citer et grandement remercier !
...
![coach carbone](/images/blog/coachcarbone-1.jpg)
![coach carbone](/images/blog/coachcarbone-2.jpg)

![coach carbone](/images/blog/coachcarbone-3.jpg)
![coach carbone](/images/blog/caf7d/coachcarbone-4.jpg)
...
Parmi les [nombreux retours](https://github.com/abc-transitionbascarbone/near-modele/issues) déjà reçus, certains soulignent qu’il serait intéressant de pouvoir préciser si son [fournisseur d’électricité est vert](https://github.com/abc-transitionbascarbone/near-modele/issues/4), le [type de carburant utilisé](https://github.com/abc-transitionbascarbone/near-modele/issues/416), etc. Tous les calculateurs sont perfectibles puisque ce sont des modèles et ils simplifient la réalité pour la rendre appréhendable. Il reste que la perspective d’un bilan au gramme de CO2 près est tentante, mais illusoire et contre productive face à l’échéance à laquelle nous devons réduire nos émissions de GES. Bien connaître les grands ordres de grandeurs, comparer les catégories d’émissions entre elles, etc. apporte déjà la compréhension nécessaire pour opérer des changements dans nos vies à la hauteur de l’enjeu.  
...
Alors, c’est parti, commençons à perdre nos kilos et tonnes de CO2 en trop dès maintenant grâce [au calculateur](https://nosgestesclimat.fr/) !
