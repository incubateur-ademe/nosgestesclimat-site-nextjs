...
description: Toutes les actions de réduction d'empreinte carbone, quel que soit le domaine, appartiennent à deux catégories faire moins (réduire l'usage), ou faire mieux (réduire l'empreinte pour le même usage).
image: /images/blog/priscilla-du-preez-rollercoaster.jpg
categories: 'Climat'
author: 'Julie Pouliquen'
---

![Un grand huit, photo de Priscilla du Preez](/images/blog/priscilla-du-preez-rollercoaster.jpg)
...
L'ensemble des actions proposées en fin de parcours par notre calculateur répond systématiquement à l'une de ces deux catégories, moins ou mieux. Mais alors, y a t-il des actions à privilégier par rapport aux autres ?
