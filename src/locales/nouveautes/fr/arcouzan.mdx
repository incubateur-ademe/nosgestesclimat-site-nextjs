...
Vous demandez de répondre sur vos dépenses annuelles en € n'était pas une question "cadeau"... Beaucoup d'entre vous répondaient "Je ne sais pas" à cette question : nous avons donc choisi de [revoir cette question](https://github.com/abc-transitionbascarbone/near-modele/pull/1997) pour vous proposer 3 choix de réponses [basés sur les données INSEE des dépenses des ménages](https://nosgestesclimat.fr/documentation/divers/autres-produits).
...
- La mise à jour du [facteur d'émission du mix électrique français](https://github.com/abc-transitionbascarbone/near-modele/pull/1993).
- [Nombreuses corrections de coquilles](https://github.com/abc-transitionbascarbone/near-modele/pull/2049).

**Nous travaillons actuellement sur [une charte d'écriture pour notre modèle de calcul](https://github.com/abc-transitionbascarbone/near-modele/issues/2076) dans le but de faciliter les développements de l'application, mais également aider à la prise en main des données pour des intégrateurs externes.**
