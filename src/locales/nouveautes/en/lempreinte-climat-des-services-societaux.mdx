...
To get there, we obviously need to know _where we are_ today and how things are evolving each year.
...
In parallel, the nosgestesclimat calculation model is a compilation of so-called "micro" models: you are asked a multitude of questions to reconstruct _your carbon footprint_ from physical consumption data.
...
<summary>
  <i>Find out more about the breakdown by sales of SDES carbon data</i>
</summary>
