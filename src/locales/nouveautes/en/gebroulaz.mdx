...
With the arrival of the km entry aid in <a href="https://nosgestesclimat.fr/nouveaut%C3%A9s/las-n%C3%A9ous">the latest release</a>, a question remained as to the choice of vehicle fill rate applied to attribute depreciation to the various car users. The details are available in issue #1337 and in the <a href="https://github.com/abc-transitionbascarbone/near-modele/blob/8fe4b633502fe52dda7eccdc0e9db01b9f677e57/data/transport/transport%20.%20voiture.yaml#L53">note on the "passenger ratio" variable</a>. 
...
Contribution made easy for non-dev contributors! Repositories have been configured to let you modify or add new features in real time via a development environment directly in your browser. We explain it all in the <a href="https://github.com/abc-transitionbascarbone/near-modele/blob/master/CONTRIBUTING.md#vous-voulez-contribuer-comme-un-pro">Gitpod tutorial</a>! 
