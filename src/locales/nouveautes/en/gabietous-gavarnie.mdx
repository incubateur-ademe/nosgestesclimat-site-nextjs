...
gabiétous Glacier](https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Gavarnie_recti_small_Wikimedia_Commons.jpg/640px-Gavarnie_recti_small_Wikimedia_Commons.jpg)

> In short :
&gt
> - New animated graphic during the simulation
...
> - More personalised end screen (simulation not started, not finished, low climate score, etc.)
...
For the tutorial, and the end screen, we're monitoring the slide throughput rate. We've made the next button more obvious via an animation, and now display the slides as circles above the slides.
...
## New educational sheets

We've added comprehensive fact sheets to explore in more depth what you can do for your digital footprint, through teleworking, for your personal savings, and so on.
