...
Secondly, we've completed the proposed actions following the <a href="https://nosgestesclimat.fr/calculateur/bilan?mtm_campaign=nouveautes-simu">test</a> on all categories 
