...
- <a href="https://nosgestesclimat.fr/blog/mobilites/alternatives-voiture-individuelle">
    Alternatives to the private car
  </a>
- <a href="https://nosgestesclimat.fr/blog/actualites-et-fonctionnalites/challenge-tes-amis">
    Challenge your friends on their carbon footprint
  </a>
...
- Without going into too much technical detail, we used to use an API to load the template in numerous places on the site. We've replaced this with a more appropriate mechanism, capable of holding the load and preventing the site from _crashing_ 💥 when traffic peaks (as we experienced in December during France Inter's Carbon Day).
...
### 🪲 We've fixed _NOT SOME_ of the bugs that have a nasty habit of creeping in
...
<div className="text-center">
  <a
    ...
    className="transition-color border-primary-500 bg-primary-500 hover:bg-primary-700 focus:ring-primary-700 mx-auto inline-flex items-center rounded-md border-2 !p-4 font-bold whitespace-nowrap !text-white no-underline shadow-sm transition-colors hover:text-white focus:ring-2 focus:ring-offset-3 focus:outline-none aria-disabled:opacity-50">
