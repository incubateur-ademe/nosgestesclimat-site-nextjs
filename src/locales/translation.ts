...
const uiFr = parseYaml(uiFrYaml as any)
const uiEn = parseYaml(uiEnYaml as any)
...
const faqFr = parseYaml(faqFrYaml as any)
const faqEn = parseYaml(faqEnYaml as any)
