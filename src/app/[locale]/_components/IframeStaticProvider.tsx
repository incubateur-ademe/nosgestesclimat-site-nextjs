...
export const IframeStaticContext = createContext<{
  isIframe?: boolean
...
const IframeStaticProvider = ({ children }: { children: React.ReactNode }) => {
...
export default IframeStaticProvider
