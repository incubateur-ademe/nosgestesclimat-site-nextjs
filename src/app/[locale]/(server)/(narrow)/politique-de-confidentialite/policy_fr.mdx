...
Nous utilisons en parallèle l'outil Posthog pour mesurer l'audience et améliorer notre site. Il est également configuré en mode "exempté", conformément aux [recommandations de la CNIL](https://www.cnil.fr/fr/solutions-pour-la-mesure-daudience). Elle ne nécessite donc pas le consentement des personnes concernées non plus. Vous pouvez également malgré tout vous opposer au suivi de votre navigation en décochant la case ci-dessous.
