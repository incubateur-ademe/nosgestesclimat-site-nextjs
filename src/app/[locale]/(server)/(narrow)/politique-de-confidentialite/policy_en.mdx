...
<iframe
  title="matomo"
  className="min-h-56"
  src="https://stats.beta.gouv.fr/index.php?module=CoreAdminHome&action=optOut&language=fr&backgroundColor=&fontColor=&fontSize=&fontFamily=&language=en"
/>

##### Posthog

We also use the Posthog tool to measure audience and improve our site. It is also configured in "exempt" mode, in accordance with [CNIL recommendations](https://www.cnil.fr/fr/solutions-pour-la-mesure-daudience). It therefore does not require the consent of data subjects either. You can nevertheless object to the tracking of your navigation by unchecking the box below.
