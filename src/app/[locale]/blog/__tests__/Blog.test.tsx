...
describe('BlogHomePage', () => {
  ...
  describe('Redirections', () => {
    it('should redirect ES locale to FR when content is missing', async () => {
      // Mock missing content for ES locale
      mockFetchHomepageContent.mockResolvedValue({
        title: undefined,
      ...
      const params = Promise.resolve({ locale: 'es' as Locale })
    ...
    it('should redirect ES locale to FR when only some content is missing', async () => {
      // Mock partial content for ES locale
      mockFetchHomepageContent.mockResolvedValue({
        title: 'Test Title',
    ...
    it('should NOT redirect ES locale when all content is present', async () => {
      const params = Promise.resolve({ locale: 'es' as Locale })
      const searchParams = Promise.resolve({ page: '1' })
    ...
    it('should call notFound for non-ES locales when content is missing', async () => {
    ...
    it('should call notFound for non-ES locales when only some content is missing', async () => {
