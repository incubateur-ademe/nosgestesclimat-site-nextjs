...
import rules from './publicodes-voyagevelo.model.json'

// Initialiser le moteur Publicodes
const engine = new Engine(rules as unknown as ParsedRules, {
  strict: {
    noOrphanRule: true,
...
export default function SousSimulateurPage() {
  ...
  return (
    <>
      <h1>Sous Simulateur "Voyage Vélo"</h1>
      <h2>Questions</h2>
                ...
                return (
                  <div>
                    ...
                    <NumberInput
                      ...
                      setValue={(value) =>
                        handleChange(pageElement.id, value as number)
                      }
