...
export default async function Landing() {
  ...
  return (
    <>
      <Main>
        <div className="mx-auto flex flex-col justify-center gap-4 px-4 pb-8 text-center md:mx-auto md:mt-6 md:w-full md:max-w-5xl md:pb-8 md:pt-12 md:text-left">
