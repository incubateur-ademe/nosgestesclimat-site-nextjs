  ...
  return (
    <div className={`flex flex-col ${className}`} aria-live="polite">
      ...
      <SelectTag
        ...
        classNames={{
          control: () =>
            'min-h-none md:min-h-[38px] !p-2 !py-3 border-gray-300 rounded-md border border-solid !bg-gray-100  text-sm transition-colors focus:border-primary-700 focus:ring-2 focus:ring-primary-700',
