    ...
    <InputGroup
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          type="checkbox"
          className={twMerge(
            'focus:border-primary-700 focus:ring-primary-700 cursor-pointer rounded-xl border-2 border-solid border-gray-200 bg-gray-100 !p-4 text-2xl transition-colors focus:ring-2',
