    ...
    <div className={`flex flex-col ${className}`} aria-live="polite">
      ...
      <select
        ...
        className={twMerge(
          ...
          } max-w-[30rem] !cursor-pointer rounded-xl border-2 border-solid bg-gray-100 p-4 text-sm transition-colors focus:border-primary-700 focus:ring-2 focus:ring-primary-700`,
          `${className} ${
