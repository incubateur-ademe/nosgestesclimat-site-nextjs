...
import type { CompletedSimulationProgress } from '@nosgestesclimat/core/features/simulations/types/simulation-progress'
...
export default function AdaptiveMessage({
  ...
  const isTestCompleted = !!completedSimulation
